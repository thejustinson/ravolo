  ...
  return (
    <div className="py-16 sm:py-12 md:py-16 lg:py-20 px-10 h-[calc(100vh-60px)] lg:h-[calc(100vh-85px)] lg:px-20 relative">
      <div className="relative max-w-3xl mx-auto z-[5]">
        <motion.p 
          className="text-center mx-auto text-main-green bg-main-green py-1 px-3 rounded-full border border-main-green bg-opacity-20 text-[0.6rem] sm:text-sm flex items-center gap-1 mb-5 max-w-fit"
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
        >
          <Star className='w-3 sm:w-4' /> Your Assets, Evolving Across All Worlds
        </motion.p>
        <motion.h1 
